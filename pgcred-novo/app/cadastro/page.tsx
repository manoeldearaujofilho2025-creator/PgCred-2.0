  ...
  async function handleCadastro(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setErro(dados.mensagem || "Erro ao criar conta.");
      }
    } catch {
    ...
    <main className="min-h-screen bg-[#0b0f14] flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#9ca3af] text-sm mt-2">Crie sua conta gratuitamente</p>
        </div>

        {/* Card */}
        <div className="bg-[#111827] border border-[#1e293b] rounded-2xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
          <h2 className="text-white text-xl font-extrabold mb-6">Criar conta</h2>

          {/* Sucesso */}
          {sucesso && (
            <div className="bg-[rgba(59,130,246,0.1)] border border-[rgba(59,130,246,0.3)] text-[#3B82F6] text-sm px-4 py-3 rounded-xl mb-5 flex items-center gap-2">
